...
### 9.2. Curated Menu Items (104 Unique Dishes in Seed Data)
...
- Expanded plant-forward menu at Green Haven Cafe with 18 items asserting the strict vegan vs. vegetarian dietary hierarchy.
...
- **`backend/seed/seed_data.py`**: Asynchronously seeds the master records and all 104 unique dishes with allergen associations.
